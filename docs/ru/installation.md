...
Сверьте DNS-записи **обоих доменов** с публичным IP сервера в кабинете хостинга. Запись AAAA нужна только при работающем IPv6. Проверьте TCP 80/443 как в firewall сервера, так и в сетевых правилах провайдера; порты приложений 8080/8081 открывать наружу не нужно.
