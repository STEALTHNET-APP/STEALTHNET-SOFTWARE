...
Репозиторий проекта: https://github.com/STEALTHNET-APP/STEALTHNET-SOFTWARE. Исходники и первый стабильный Release нужно опубликовать прежде, чем раздавать клиентам команду установки. До этого проверка версий в панели показывает отсутствие релизов.
...
1. Обновить версию в Cargo.toml и Cargo.lock. Подготовить понятное описание изменений, совместимости миграций и требуемых действий владельца.
