# Выпуск готовых установочных релизов
...
## Единый формат релизов

Название каждого GitHub Release: **STEALTHNET vX.Y.Z**. Краткое описание исправлений не добавляется к названию. Workflow уже создаёт черновики в этом формате; при публикации сохраняйте его.

В описании используйте русский и английский блоки: что изменилось, какие компоненты нужно обновить, команды и результаты проверок. Отдельно обозначайте панель, страницу подписки и кабинет/Mini App. Не предлагайте обновлять кабинет ради изменений только в подписке. Предупреждения о старых проблемных версиях сохраняйте в начале описания.
