...
Сначала обновите агенты до **0.1.2 или новее**. В диалоге есть кнопки обновления и проверки готовности. Старый или неизвестный агент с прежними отчётами блокирует применение новой версии; отключить управление версиями можно. Новые ноды без первого отчёта получают актуальный агент из установщика. API не передаёт команды обновления ядра старым агентам.
