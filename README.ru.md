...
**v0.1.4 · понятная настройка профилей и автоматическая подготовка ключей.**

<p>
  <a href="https://github.com/STEALTHNET-APP/STEALTHNET-SOFTWARE/releases/tag/v0.1.4"><img src="docs/media/navigation/link-ru-02.svg" width="206" height="58" alt="Скачать v0.1.4" /></a>
...
git clone --branch v0.1.4 --depth 1 https://github.com/STEALTHNET-APP/STEALTHNET-SOFTWARE.git /root/stealthnet-installer
cd /root/stealthnet-installer
bash install.sh --version v0.1.4
```
